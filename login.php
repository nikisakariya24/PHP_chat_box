...
<html lang="">
    <head>
        ...
        <!-- include JS file -->
        <script src="./js/login_validation.js" language="javascript" type="text/javascript"></script>
        ...
        <div class="container">
            ...
            <div class="col-8 m-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <!-- Form -->
                    <form action="#" method="post" name="login" class="shadow-lg p-4 bg-light" onSubmit="return validation(login)">

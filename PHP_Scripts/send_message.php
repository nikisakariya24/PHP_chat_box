...
$insert = "insert into chat_message(to_user_id,from_user_id,message) values($to_user_id,$user_id,'$chat_message')";
...
{   
    ...
    //         $output .= '<li class="list-group-item list-group-item-'.$class.'">'.$row['message'].$user.$time.'</li>';
    //     }
    //     $output .= '</ul>';
    // }
}
